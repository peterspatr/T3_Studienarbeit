...
\newcommand{\titel}{Realisierung eines Vier-Gewinnt Roboters}
\newcommand{\untertitel} {Teil 1: Spieltheorie }
...
\newcommand{\matrikelnr}{8379878/ 4995162}
...
\include{chapter/Grundlagen des Spiels Vier Gewinnt}
\include{chapter/Spieltheoretische Grundlagen}
\include{chapter/Analyse von Vier Gewinnt aus spieltheoretischer Sicht}
\include{chapter/Lösungsansätze für Vier Gewinnt}
\include{chapter/Anwendung der Spieltheorie auf Vier Gewinnt}
...
%%---------Notizen---------------------------
%\include{chapter/Besprechungsnotizen}
%\include{chapter/Anforderungsliste}
