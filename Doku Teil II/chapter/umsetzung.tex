...
\begin{tikzpicture}[node distance=2cm]
	...
	\node (update) [process, below of=scan] {Spielfeld-Update};
...
Stattdessen liegt der Fokus auf den wesentlichen Programmabschnitten, die das Spielverhalten maßgeblich bestimmen. siehe anhang 
